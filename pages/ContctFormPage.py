...
class ContactForm(BaseClass):
    ...
    def enterCaptha(self):
        ...
        self.takeScreenshot("After fill all data")
    ...
    def clickOnPostButton(self):
        ...
        self.takeScreenshot("Clicked on post button")
